...
import { MapPin, Bed, Bath, Maximize, Heart, ArrowLeft, Phone, Mail, Share2, Play, X, ChevronRight, ChevronLeft } from 'lucide-react';
                ...
                <section className="lg:grid lg:grid-cols-[55%_45%] relative">
                    ...
                    <div className="px-6 py-8 md:px-12 md:py-16 bg-white">
                        <div className="max-w-xl mx-auto">
                            ...
                            {/* Info Line (Specs) */}
                            <div className="py-4 border-y border-dashed border-gray-200 mb-8 flex flex-wrap gap-x-8 gap-y-2 text-sm uppercase tracking-[0.15em] text-gray-500 font-medium">
                                ...
                                <span>|</span>
                                <span className="text-luxury-charcoal">Dep: 10%</span>
                            </div>
                            ...
                            {/* Description */}
                            <div className="prose prose-sm max-w-none text-gray-600 font-light mb-12 leading-relaxed">
                        ...
                        >
                            ...
                            <form className="space-y-6">
                                <div className="space-y-1">
                                    ...
                                    <input type="text" className="w-full border-b border-gray-200 py-2 focus:outline-none focus:border-luxury-charcoal transition-colors bg-transparent placeholder-gray-300" placeholder="JANE DOE" />
                                </div>
                                <div className="space-y-1">
                                    <label className="text-[10px] uppercase tracking-widest font-bold text-gray-400">Email</label>
                                    <input type="email" className="w-full border-b border-gray-200 py-2 focus:outline-none focus:border-luxury-charcoal transition-colors bg-transparent placeholder-gray-300" placeholder="EMAIL@EXAMPLE.COM" />
                                </div>
                                <div className="space-y-1">
                                    <label className="text-[10px] uppercase tracking-widest font-bold text-gray-400">Message</label>
                                    <textarea rows="3" className="w-full border-b border-gray-200 py-2 focus:outline-none focus:border-luxury-charcoal transition-colors bg-transparent placeholder-gray-300 resize-none" placeholder="I am interested..."></textarea>
                                </div>

                                <button type="button" className="w-full py-4 bg-luxury-charcoal text-white text-xs uppercase tracking-[0.2em] font-medium hover:bg-black transition-colors mt-4">
                                    Send Inquiry
                                </button>
                            </form>
                        </motion.div>
